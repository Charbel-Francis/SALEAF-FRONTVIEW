...
export const PaymentSuccessIcon = (props) => {
  return (
    <Svg
      width="100"
      height="100"
    ...
    >
      <G clipPath="url(#clip0)">
        <Path
          d="M150 0C67.1573 0 0 67.1573 0 150C0 232.843 67.1573 300 150 300C232.843 300 300 232.843 300 150C300 67.1573 232.843 0 150 0ZM150 273.75C82.5 273.75 26.25 217.5 26.25 150C26.25 82.5 82.5 26.25 150 26.25C217.5 26.25 273.75 82.5 273.75 150C273.75 217.5 217.5 273.75 150 273.75Z"
          fill="#4CAF50"
        />
        <Path
          d="M121.875 206.25L67.5 151.875L90.625 128.75L121.875 160L209.375 72.5L232.5 95.625L121.875 206.25Z"
          fill="white"
        />
      </G>
      <Defs>
