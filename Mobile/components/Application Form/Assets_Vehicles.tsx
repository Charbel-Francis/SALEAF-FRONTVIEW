        ...
        >
          <View style={styles.cardHeader}>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              {title !== "Vehicle 1" && (
                <TouchableOpacity
                  onPress={() => deleteVehicle(parseInt(fieldName.slice(7)))}
                >
            ...
            renderCard(
              ...
              <View key={vehicle.id}>
                <InputField
                  ...
                  icon={<Ionicons name="car" size={20} color="gray" />}
                  style={styles.input}
                />
                <InputField
                  ...
                  icon={<Ionicons name="document" size={20} color="gray" />}
                  style={styles.input}
                />
                <InputField
                  label="Present Value"
