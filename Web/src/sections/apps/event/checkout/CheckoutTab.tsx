...
import BillingAddress from 'sections/apps/event/checkout/BillingAddress';
import Cart from 'sections/apps/event/checkout/Cart';
import CartEmpty from 'sections/apps/event/checkout/CartEmpty';
import Payment from 'sections/apps/event/checkout/Payment';
